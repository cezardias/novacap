...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', utf8_encode('PROCESSO JUDICIAL'));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', utf8_encode('AUTOR'));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1', utf8_encode('RÉU'));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1', utf8_encode('TIPO AUDIÊNCIA'));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', utf8_encode('VARA'));
...
foreach($audienciasresult as $aud):	
	...
	if($AudienciaDataHora != ""){
		...
		//$AudienciaHora = date('H:i',strtotime($AudienciaDataHora));
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$linha, utf8_encode($ProcessoJud));
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$linha, utf8_encode($Autor));
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D'.$linha, utf8_encode($Reu));
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E'.$linha, utf8_encode($AudienciaTipo));
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$linha, utf8_encode($Vara));
