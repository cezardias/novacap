...
function excluir(IdPgtoAcao,AcaoId){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cfinanceiro/delete/"+IdPgtoAcao+"/"+AcaoId+"/5"; 
	} else {
		return false;
	}
}		
...
<div class="row" style="width:960px;">
	<div class="well well-sm" style="width:960px;">
		<h2>Financeiro - Depósitos judiciais - CONVOLADOS</h2>
		<font size="3">
...
<form role="form" method="post" action="<?php echo base_url();?>cfinanceiro/createdepositojudconvolados" name="formdepjud">
...
<?php }
if(!empty($depositosjudconvolados)&&(sizeof($depositosjudconvolados)>0)){?>
<div class="row">
	<div class="col-md-6">
		<table class="table" style="width:960px;margin-left:-15px;">
			...
			<tbody>
				<?php foreach ($depositosjudconvolados as $itens):
				$IdPgtoAcao = $itens->Id;
