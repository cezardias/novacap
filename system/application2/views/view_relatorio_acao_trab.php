...
$this->load->library('Fpdf_Table_acao_trab_vertical.php');
$pdf=new Fpdf_Table_acao_trab_vertical('P','mm','A4');
...
if($acaodetail!=NULL):
	foreach ($acaodetail as $itens):
		...
		$ProcessoSEI = $itens->SEI;
		if($ProcessoSEI != ""){ //00112-00005028/2018-31
		    $parte1 = substr($ProcessoSEI, 0, 5);
		    $parte2 = substr($ProcessoSEI, 5, 8);
		    $parte3 = substr($ProcessoSEI, 13, 4);
		    $parte4 = substr($ProcessoSEI, 17, 2);
		    $ProcessoSEI = $parte1.'-'.$parte2.'/'.$parte3.'-'.$parte4;
		}else{$ProcessoSEI = '';}
	...
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'PROCESSO ADMINISTRATIVO:', 'width' => '55', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'T');
	$col[] = array('text' => $ProcessoAdmin, 'width' => '55', 'height' => '6', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'TR');
	$col[] = array('text' => 'VALOR DA CAUSA: ', 'width' => '45', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'TL');
	...
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'PROCESSO SEI:', 'width' => '55', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$col[] = array('text' => $ProcessoSEI, 'width' => '55', 'height' => '6', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'R');
	$col[] = array('text' => 'VALOR DA SENTENÇA: ', 'width' => '45', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'L');
	$col[] = array('text' => $SentencaValor, 'width' => '35', 'height' => '6', 'align' => 'R', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);
	
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'PROCESSO JUDICIAL:', 'width' => '55', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$col[] = array('text' => $ProcessoJud, 'width' => '55', 'height' => '6', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'R');
	$col[] = array('text' => 'VALOR DO ACÓRDÃO: ', 'width' => '45', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'L');
	$col[] = array('text' => $AcordaoValor, 'width' => '35', 'height' => '6', 'align' => 'R', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);
	
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'PROCESSO PAI:', 'width' => '55', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$col[] = array('text' => $ProcessoPai, 'width' => '55', 'height' => '6', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'BR');
	$col[] = array('text' => 'VALOR DA CONDENAÇÃO: ', 'width' => '45', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'BL');
	$col[] = array('text' => $CondenacaoValor, 'width' => '35', 'height' => '6', 'align' => 'R', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);	
	...
	$col[] = array('text' => $DataDoAjuizamento, 'width' => '40', 'height' => '6', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	...
	$col[] = array('text' => 'CAIXA:', 'width' => '18', 'height' => '6', 'align' => 'C', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$col[] = array('text' => $Caixa, 'width' => '10', 'height' => '6', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$col[] = array('text' => 'STATUS:', 'width' => '17', 'height' => '6', 'align' => 'C', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$col[] = array('text' => $Ativo, 'width' => '15', 'height' => '6', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);
	
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'OBSERVAÇÕES:', 'width' => '190', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'T');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);
	...
	if($acao_assuntos!=NULL):
		foreach($acao_assuntos as $ass):
			...
			$col[] = array('text' => $Paradigma, 'width' => '95', 'height' => '6', 'align' => 'J', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
			$titulo[] = $col;
			$pdf->WriteTable($titulo);
		endforeach;	
	else:
		...
		$titulo = array();
		$col = array();	 
		$col[] = array('text' => 'NENHUM ASSUNTO CADASTRADO', 'width' => '190', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
		$titulo[] = $col;
		$pdf->WriteTable($titulo);	
	endif;
	...
	$titulo = array();
	$col = array();	 
	$col[] = array('text' => 'AUDIÊNCIAS', 'width' => '190', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);		
	...
	if($audiencias!=NULL):
		...
		foreach($audiencias as $aud):
			...
			endforeach;		
			$AudienciaPreposto = $aud->AudienciaPreposto; if($AudienciaPreposto=="NULL"){$AudienciaPreposto="";}
			$AudObservacao = $aud->Observacao; if($AudObservacao=="NULL"){$AudObservacao="";}
		...
		$titulo = array();
		$col = array();	 
		$col[] = array('text' => 'NENHUMA AUDIÊNCIA CADASTRADA', 'width' => '190', 'height' => '6', 'align' => 'L', 'alignv' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		$titulo[] = $col;
		$pdf->WriteTable($titulo);		
	endif;
	...
	$titulo = array();
	$col = array();
	$col[] = array('text' => 'NENHUM PRAZO CADASTRADO', 'width' => '190', 'height' => '6', 'align' => 'J', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	$titulo[] = $col;
	$pdf->WriteTable($titulo);
	endif;	
	...
	if($andamentos!=NULL): //Se existe assuntos
		$titulo = array();
		$col = array();	 
