...
<div id="tabs-1">
<form method="post" action="<?php echo base_url();?>cacaocivel/saveprazocivel" name="formprazo" onsubmit="return validaprazo()">
...
<div class="row">
	...
	<a href="<?php echo base_url()."cjuridico/detailacao/".$IdAcao."#tabs-6";?>"><input type="button" value="Cancelar" onclick="location.href('<?php echo base_url()."cjuridico/detailacao/".$IdAcao."#tabs-6";?>')" class="botao"></a>
<?php } ?>	
</div>
<?php
} 
