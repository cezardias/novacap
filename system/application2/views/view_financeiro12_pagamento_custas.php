...
function excluir(IdPgtoAcao,AcaoId){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cfinanceiro/delete/"+IdPgtoAcao+"/"+AcaoId+"/12"; 
	} else {
		return false;
	}
}		
...
<div class="row" style="width:960px;">
	<div class="well well-sm" style="width:960px;">
		<h2>Financeiro - Pagamento de custas</h2>
		<font size="3">
...
<form role="form" method="post" action="<?php echo base_url();?>cfinanceiro/createpagamentocustas" name="formdepjud">
...
<?php }
if(!empty($pagamentocustas)&&(sizeof($pagamentocustas)>0)){?>
<div class="row">
	<div class="col-md-6">
		<table class="table" style="width:930px;">
			...
			<tbody>
				<?php foreach ($pagamentocustas as $itens):
				$IdPgtoAcao = $itens->Id;
