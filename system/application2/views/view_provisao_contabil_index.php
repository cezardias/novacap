...
<fieldset class=visible style='width:938px; margin-left:-3px; background-color: #87CEFA;'>
	<font size="5">Relatório de Provisão Contábil</font>
</fieldset>

<fieldset class='visible' style='width:938px; margin-left:-3px;'>
<form method="post" action="<?php echo base_url();?>cjuridico/relatodeprovcontresult" name="formbuscacao" onsubmit="return validauditoria()">
<?php 
...
<form method="post" action="<?php echo base_url();?>cjuridico/relatodeprovcont" name="formauditoria" onsubmit="return validauditoria()">
<br>
