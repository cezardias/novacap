...
function excluir(IdPgtoAcao,AcaoId){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cfinanceiro/delete/"+IdPgtoAcao+"/"+AcaoId+"/1"; //registrar pagamento
	} else {
		return false;
	}
}		
...
<div class="row" style="width:960px;">
	<div class="well well-sm" style="width:960px;">
		<h2>Financeiro - Pagamento de ações</h2>
		<font size="3">
...
<form role="form" method="post" action="<?php echo base_url();?>cfinanceiro/createpgtoacao" name="formpgtoacao">
	<input type="hidden" name="acaoid" id="acaoid" value="<?php echo $AcaoId?>">
	<div class="row col-md-12" style="width:960px;margin-left: -30px;">
		<div class="col-md-3">
...
<?php } 
if(!empty($pagamentoacoes)&&(sizeof($pagamentoacoes)>0)){?>
<div class="row">
	<div class="col-md-6">
		<table class="table" style="width:960px;margin-left:-15px;">
			...
			<tbody>
				<?php foreach ($pagamentoacoes as $pgtoac):
