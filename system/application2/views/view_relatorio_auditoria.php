<?php
$this->load->library('Fpdf_Table_Horizontal_auditoria.php');
$pdf=new Fpdf_Table_Horizontal_auditoria('L','mm','A4');
...
if($auditoriaresult!=NULL):
	...
	foreach ($auditoriaresult as $audt):
		...
		$titulo = array();
		$col = array();
		$col[] = array('text' => $InteressadoNome, 'width' => '50', 'height' => '3', 'align' => 'L', 'font_name' => 'Courier', 'font_size' => '6', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		...
		$col[] = array('text' => $Assunto, 'width' => '45', 'height' => '3', 'align' => 'L', 'font_name' => 'Courier', 'font_size' => '6', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		...
		$col[] = array('text' => $CausaValor, 'width' => '24', 'height' => '3', 'align' => 'R', 'font_name' => 'Courier', 'font_size' => '6', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		$col[] = array('text' => $SetencaValor, 'width' => '24', 'height' => '3', 'align' => 'R', 'font_name' => 'Courier', 'font_size' => '6', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		$col[] = array('text' => $AcordaoValor, 'width' => '24', 'height' => '3', 'align' => 'R', 'font_name' => 'Courier', 'font_size' => '6', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
