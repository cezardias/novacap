...
foreach ($acaodetail as $acao):
	...
	$DtaCausa = $acao->CausaData; if($DtaCausa==""){$DtaCausa='';}else{$DtaCausa = date('d/m/Y',strtotime($DtaCausa));}
	$DtaSentenca = $acao->SentencaData; if($DtaSentenca==""){$DtaSentenca='';}else{$DtaSentenca = date('d/m/Y',strtotime($DtaSentenca));}
	$DtaAcordao = $acao->AcordaoData; if($DtaAcordao==""){$DtaAcordao='';}else{$DtaAcordao = date('d/m/Y',strtotime($DtaAcordao));}
	$DtaCalculoHomologado = $acao->CalculoHomologadoData; if($DtaCalculoHomologado==""){$DtaCalculoHomologado='';}else{$DtaCalculoHomologado = date('d/m/Y',strtotime($DtaCalculoHomologado));}
	$DtaCondenacao = $acao->CondenacaoData; if($DtaCondenacao==""){$DtaCondenacao='';}else{$DtaCondenacao = date('d/m/Y',strtotime($DtaCondenacao));}
...
<ul>
	...
	<li><a href="#tabs-7" id="mostrar7">Extrato de contigênciamento</a></li>
</ul>
...
<div class="row">
	...
	Processo pai
	<div class="field">
		<input type="text" name="prpai" id="prpai" maxlength="25" size="20"  value="<?php echo $ProcessoPai;?>" readonly style="background-color:#F2F2F2;"/>
	</div>

	<!--&nbsp;&nbsp;
	Valor Econômico do Risco
	<div class="field">
		<input type="text" name="prpai" id="prpai" maxlength="25" size="20"  value="<?php echo $ValorEconomicoDoRisco;?>" readonly style="background-color:#F2F2F2;"/>
	</div>-->
...
<div class="row">
		...
		<input type="text" name="fundlegal" id="fundlegal" value="DATA" size="20" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
...
<div class="row">
		<div class="field">
		<input type="text" name="dtacausa" id="dtacausa" value="<?php echo date('d/m/Y H:i',strtotime($DtaCausa));?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="CAUSA" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
...
<div class="row">
		<div class="field">
		<input type="text" name="dtasentenca" id="dtasentenca" value="<?php echo date('d/m/Y H:i',strtotime($DtaSentenca));?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="SENTENÇA" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
...
<div class="row">
		<div class="field">
		<input type="text" name="dtaacordao" id="dtaacordao" value="<?php echo date('d/m/Y H:i',strtotime($DtaAcordao));?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="acordamvalor" id="acordaovalor" value="<?php echo $AcordaoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="dtacalculohomologado" id="dtacalculohomologado" value="<?php echo date('d/m/Y H:i',strtotime($DtaCalculoHomologado));?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="calchomovalor" id="calchomovalor" value="<?php echo $CalculoHomologadoValor;?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="dtacondenacao" id="dtacondenacao" value="<?php echo date('d/m/Y H:i',strtotime($DtaCondenacao));?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="condenavalor" id="condenavalor" value="<?php echo $CondenacaoValor;?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
</a>
<a href="<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="EDITAR" onclick="location.href('<?php echo base_url()."cacaocivel/detailacaotrab/".$IdAcao;?>')" class="botao">
</a>
