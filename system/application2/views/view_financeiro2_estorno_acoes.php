...
function excluir(IdPgtoAcao,AcaoId){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cfinanceiro/delete/"+IdPgtoAcao+"/"+AcaoId+"/2"; //deletar estorno
	} else {
		return false;
	}
}		
...
<div class="row" style="width:960px;">
	<div class="well well-sm" style="width:960px;">
		<h3>Financeiro - pagamento de ações - ESTORNO</h3>
		<font size="3">
...
<form role="form" method="post" action="<?php echo base_url();?>cfinanceiro/createstornopgtoacao" name="formestornopgtoacao">
...
<?php }
if(!empty($estornopgtoacoes)&&(sizeof($estornopgtoacoes)>0)){?>
<div class="row">
	<div class="col-md-6">
		<table class="table" style="width:960px;margin-left:-15px;">
			...
			<tbody>
				<?php foreach ($estornopgtoacoes as $pgtoac):
