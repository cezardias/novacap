...
class Fpdf_Table_Horizontal_auditoria extends FPDF{
   var $left = 10;
   var $right = 10;
   var $top = 10;
   var $bottom = 10;
   ...
   function Header(){
      ...
      $this->Text(123,23,utf8_decode('RELATÓRIO DE PROVISÃO CONTÁBIL'));
      $this->Text(9,30,utf8_decode($_SESSION['filtro']));

      $this->SetFont('Courier','B',7);
      $this->SetFillColor(211,211,211);
      $this->SetXY(10,27);
      $this->MultiCell(276,5,utf8_decode($_SESSION['filtro']),1,'J',1,0);

      $this->SetXY(180,27);
      $this->MultiCell(107,5,'VALORES',1,'C',1,0);

      $this->SetXY(10,32);
      $this->MultiCell(50,5,utf8_decode("AUTOR / RÉU"),1,'C',1,0);
      $this->SetXY(60,32);
      $this->MultiCell(35,5,"PROC. JUDICIAL",1,'C',1,0);
      $this->SetXY(95,32);
      $this->MultiCell(23,5,"PROC. ADMIN.",1,'C',1,0);
      $this->SetXY(118,32);
      $this->MultiCell(45,5,"ASSUNTO",1,'C',1,0);
      $this->SetXY(163,32);
      $this->MultiCell(17,5,"PROB PERDA",1,'C',1,0);
      $this->SetXY(180,32);
      $this->MultiCell(24,5,"CAUSA",1,'C',1,0);
      $this->SetXY(204,32) ;
      $this->MultiCell(24,5,utf8_decode("DATA EVENTO"),1,'C',1,0);
      $this->SetXY(275,32);
      $this->MultiCell(12,5,'STATUS',1,'C',1,0);
      $this->SetXY(228,32);
