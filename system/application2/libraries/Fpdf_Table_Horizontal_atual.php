...
class Fpdf_Table_Horizontal_atual extends FPDF{
	var $left = 10;
	var $right = 10;
	var $top = 10;
	var $bottom = 10;
	...
	function Header(){
      ...
      $this->Text(9,30,utf8_decode($_SESSION['filtro']));
		...
		$this->SetXY(10,32);
		$this->MultiCell(93,5,utf8_decode("AUTOR / RÉU"),1,'C',1,0);
		$this->SetXY(103,32);
		$this->MultiCell(35,5,"PROC. JUDICIAL",1,'C',1,0);
		$this->SetXY(138,32);
		$this->MultiCell(23,5,"PROC. ADMIN.",1,'C',1,0);
		$this->SetXY(161,32);
		$this->MultiCell(55,5,"ASSUNTO",1,'C',1,0);
		$this->SetXY(216,32);
		$this->MultiCell(17,5,"PROB PERDA",1,'C',1,0);
		$this->SetXY(233,32);
		$this->MultiCell(25,5,"CAUSA",1,'C',1,0);
		$this->SetXY(256,32)	;
		$this->MultiCell(19,5,utf8_decode("DATA EVENTO"),1,'C',1,0);
      $this->SetXY(275,32);
      $this->MultiCell(11,5,'STATUS',1,'C',1,0);
		//$this->SetXY(228,32);
