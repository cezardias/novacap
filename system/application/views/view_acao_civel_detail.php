...
function excluiassunto(AcoesId,IdRegAssunto,AcaoTipoId){
	var confirma = confirm("Deseja realmente excluir este registro?")
	if (confirma){
		window.location = "<?php echo base_url();?>cassuntocivel/delete/"+AcoesId+"/"+IdRegAssunto+"/"+AcaoTipoId;
	} else {
		return false;
	}
}
...
function assuntoprincipal(AcoesId,AssuntoId,AcaoTipoId){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cacaocivel/updateprincipal/"+AcoesId+"/"+AssuntoId+"/"+AcaoTipoId;
	} else {
		return false;
	}
}
...
function excluiaudiencia(AcaoId,IdRegAud,AcaoTipoId){
	var confirma = confirm("Deseja realmente excluir este registro?")
	if (confirma){
		window.location = "<?php echo base_url();?>caudienciacivel/delete/"+AcaoId+"/"+IdRegAud+"/"+AcaoTipoId;
	} else {
		return false;
	}
}

function excluiandamento(AcaoId,IdRegAnd,AcaoTipoId){
	var confirma = confirm("Deseja realmente excluir este registro?")
	if (confirma){
		window.location = "<?php echo base_url();?>candamentocivel/delete/"+AcaoId+"/"+IdRegAnd+"/"+AcaoTipoId;
	} else {
		return false;
	}
}
...
function alterastatus(IdPrazo,Concluido,IdAcao){
	...
	if (confirma){
		window.location = "<?php echo base_url();?>cacaocivel/status_prazo_acao_civel_detail/"+IdPrazo+"/"+Concluido+"/"+IdAcao;
	} else {
		return false;
	}
}
...
<fieldset class=visible style='width:938px;margin-left:0px;background-color: #87CEFA;'>
	<font size="5">Detalhamento de ação cível</font>
</fieldset>
...
<div id="tabs">
<ul>
	<li><a href="#tabs-1" id="ocultar">Ação</a></li>
	<li><a href="#tabs-2" id="mostrar1">Autor/Réu</a></li>
	<li><a href="#tabs-3" id="mostrar2">Assuntos</a></li>
	<li><a href="#tabs-4" id="mostrar3">Audiências</a></li>
...
<div class="row">
	...
	<div class="field">
		<input type="text" name="prjudantigo" id="prjudantigo" maxlength="25" size="27"  value="<?php echo $PrJudicialAnt?>" readonly style="background-color:#F2F2F2;text-transform: uppercase;"/>
	</div>
	&nbsp;&nbsp;
	CNJ
	<div class="field">
		<input type="text" name="prjud_cnj" id="prjud_cnj" maxlength="25" size="27"  value="<?php echo $ProcessoJud?>" onkeypress='MaskPrJud(this, event); return SomenteNumero(event)' readonly style="background-color:#F2F2F2;"/>
	</div>
</div>

<div class="row">
	<div class="label">Processo admin.<font style="color:white;font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="pradm" id="pradm" value="<?php echo $ProcessoAdmin?>" size="15" maxlength="16" onkeypress='MaskPrAdm(this, event); return SomenteNumero(event)' readonly style="background-color:#F2F2F2;"/>
	</div>
	&nbsp;
	Processo SEI
	<div class="field">
...
<div class="row">
	<div class="label">Fundamento Legal<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="<?php echo $FundamentoLegal?>" maxlength="50" size="80" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
</div>

<!--div class="row">
	<div class="label">C&aacute;lculo homologado<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="calchomovalor" id="calchomovalor" size="16" value="<?php echo $CalculoHomologadoValor?>" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;background-color:#F2F2F2;" readonly/>
	</div>
	&nbsp;&nbsp;
	C&aacute;lculo homologado Tipo
	<div class="field">
		<select name="calchomovalortipo" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
...
<div class="row">
	<div class="label">Valor da causa<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="causavalor" id="causavalor" size="16" value="<?php echo $CausaValor?>" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;background-color:#F2F2F2;" readonly/>
	</div>
	&nbsp;&nbsp;
	Causa valor Tipo
	<div class="field">
		<select name="causavalortipo" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
			<?php foreach ($auxvalorestipo as $vrltipo):
...
<div class="row">
	<div class="label">Valor da Senten&ccedil;a<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="sentencavalor" id="sentencavalor" size="16" value="<?php echo $SentencaValor?>" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;background-color:#F2F2F2;" readonly/>
	</div>
	&nbsp;&nbsp;
	Senten&ccedil;a valor Tipo
	<div class="field">
		<select name="sentensavalortipo" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
			<?php foreach ($auxvalorestipo as $vrltipo):
...
<div class="row">
	<div class="label">Valor do ac&oacute;rd&atilde;o<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="acordamvalor" id="acordamvalor" size="16" value="<?php echo $AcordaoValor?>" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;background-color:#F2F2F2;" readonly/>
	</div>
	&nbsp;&nbsp;
	Ac&oacute;rd&atilde;o valor Tipo
	<div class="field">
		<select name="acordamvalortipo" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
			<?php foreach ($auxvalorestipo as $vrltipo):
...
<div class="row">
	<div class="label">Valor condena&ccedil;&atilde;o<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="condenavalor" id="condenavalor" size="16" value="<?php echo $CondenacaoValor?>" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;background-color:#F2F2F2;" readonly/>
	</div>
	&nbsp;&nbsp;
	Condena&ccedil;&atilde;o valor Tipo
	<div class="field">
		<select name="condenacaovalortipo" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
			<?php foreach ($auxvalorestipo as $vrltipo):
...
<div class="row">
	...
	<div class="field">
		...
		if($VaraId==$vr->VaraId){?>
			...
			<input type="text" name="advogado" id="advogado" size="30"  value="<?php echo utf8_encode($vr->Nome)?>" readonly style="background-color:#F2F2F2;"/>
		<?php }
		endforeach; ?>
	</div>
</div>
...
<div class="row">
	<div class="label">Probab. de perda<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<select name="probabilidadeid" disabled style="background-color:#F2F2F2;">
			<option value=""></option>
	...
	<div class="field">
		<?php if($PosicaoNovacap==1){ ?>
			...
			<input type="radio" name="posicaonovacap" value="2" disabled/>Ré;
		<?php }else if($PosicaoNovacap==2){ ?>
			<input type="radio" name="posicaonovacap" value="1" disabled/>Autora
			<input type="radio" name="posicaonovacap" value="2" checked disabled/>Ré;
		<?php }else{ ?>
			<input type="radio" name="posicaonovacap" value="1" disabled/>Autora
			<input type="radio" name="posicaonovacap" value="2" disabled/>Ré;
		<?php } ?>
...
<div class="row">
	<div class="label">Observa&ccedil;&otilde;es<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<textarea name="observacao" rows="3" cols="100" maxlength="255" style="text-transform:uppercase;background-color:#F2F2F2;" readonly><?php echo $ObsAcaoCivil?></textarea>
	</div>
</div>

<div class="row">
	<div class="label">Status do processo<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<select name="statusprocessoid" disabled style="background-color:#F2F2F2;">
			<?php if($Ativo==1){?>
...
<div class="row">
	<div class="label">Caixa n&uacute;mero<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="cxnum" id="cxnum" size="3" maxlength="4" value="<?php echo $Caixa?>" onkeypress='return SomenteNumero(event)' readonly style="background-color:#F2F2F2;"/>
	</div>
	&nbsp;&nbsp;
	Palavras chave
	<div class="field">
		<input type="text" name="palavraschave" id="palavraschave" size="60" maxlength="60" value="<?php echo utf8_encode($PalavrasChave)?>" readonly style="background-color:#F2F2F2;"/>
	</div>
</div>

<div class="row">
	<div class="label">Processo pai<font style="color:white; font-size:7;"> &#10054;</font></div>
	<div class="field">
		<input type="text" name="prpai" id="prpai" maxlength="25" size="27"  value="<?php echo $ProcessoPai?>" readonly style="background-color:#F2F2F2;text-transform: uppercase;"/>
	</div>
	&nbsp;&nbsp;
	Valor Econômico do Risco
	<div class="field">
		<input type="text" name="prpai" id="prpai" maxlength="25" size="24"  value="valor erconomico" readonly style="background-color:#F2F2F2;"/>
	</div>
</div>
<br>
<?php if($InsercaoData!=""){ ?>
...
if($btnvoltar=='buscacaocivelresult'){ ?>
<a href="<?php echo base_url()."cacaocivel/buscacaocivelresult/";?>" style="text-decoration:none;">
	<input type="button" value="Voltar" onclick="location.href('<?php echo base_url()."cacaocivel/buscacaocivelresult/";?>')" class="botao">
</a>
<a href="<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="Alterar" onclick="location.href('<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>')" class="botao">
</a>
<?php }else if($btnvoltar=='acaocivilcreate'){ ?>
<a href="<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="Alterar" onclick="location.href('<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>')" class="botao">
</a>
<?php }else  if($btnvoltar==''){ ?>
<a href="<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="Alterar" onclick="location.href('<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>')" class="botao">
</a>
<?php }
}?>
<a href="<?php echo base_url()."cacaocivel/relatacaocivel/".$IdAcao;?>" style="text-decoration:none;" target="_blank">
	<input type="button" value="Imprimir" onclick="location.href('<?php echo base_url()."cacaocivel/relatacaocivel/".$IdAcao;?>')" class="botao">
</a>
<a href="<?php echo base_url()."cacaocivel/solautprocessoresult/".$IdAcao;?>" style="text-decoration:none;" target="_blank">
...
<a href="<?php echo base_url()."cacaocivel/buscacaocivelindex/"?>" style="text-decoration:none;">
	<input type="button" value="Pesquisar" onclick="location.href('<?php echo base_url()."cacaocivel/buscacaocivelindex/"?>')" class="botao">
</a>
</div>
</fieldset>
</div>
...
<form method="post" action="<?php echo base_url();?>cacaocivel/createinteressado" name="forminteressado" onsubmit="return validainteressado()">
...
<h3>Interessados</h3>
	<table class="data_grid" cellspacing="0">
		...
		foreach($interessadoacao as $ass):
			...
			<tr style="border:0;">
				<td width=60% style="text-transform: uppercase;"><?php echo $InteressadoNome;?></td>
				...
				<?php
					...
					<td width=10% class="middle">RÉU</td>
				<?php }				
...
<form method="post" action="<?php echo base_url();?>cacaocivel/createassuntocivel" name="formassunto" onsubmit="return validassunto()">
<input type="hidden" name="idacao" id="idacao" size="16"  value="<?php echo $IdAcao;?>"/>
<input type="hidden" name="tipoacao" id="tipoacao" size="16"  value="<?php echo $AcaoTipoId;?>"/>
...
<div class="row">
	...
	<div class="field">
		<select class="inputbox" id="assuntoid" name="assuntoid" size="1" title="Massagem Aromática" onchange="executaEventoonclick('elemento')">
			<option value=""></option>
...
<h3>Assuntos</h3>
	<table class="data_grid" cellspacing="0">
		...
		foreach($acao_assuntos as $ass):
			...
			$AcoesId = $ass->AcoesId;
			$AssuntoId = $ass->AssuntoId; //representa o assunto na mudança de principal
			...
			<tr style="border:0;<?php echo $negrito;?>">
				<td width=45% class="middle" style="text-align:left;"><?php echo utf8_encode($AssDescricao).' '.$destaca?></td>
				...
				<td width=5% class="middle">
					<a href="#"	onclick='return excluiassunto(<?php echo $AcoesId;?>,<?php echo $IdRegAssunto;?>,<?php echo $AcaoTipoId;?>);' title="Deletar este registro."><img src="<?php echo base_url();?>img/icons/delete.png" alt="apagar" /></a>
				</td>
				<?php }else{ ?>
...
<fieldset class='visible' style='width:865px'>
<div class="divspoiler">
	<input type="button" value="Cadastrar audiência" class="tamanhobotao" onclick="if(this.parentNode.nextSibling.childNodes[0].style.display != '') { this.parentNode.nextSibling.childNodes[0].style.display = ''; this.value = 'Cancelar cadastro'; } else { this.parentNode.nextSibling.childNodes[0].style.display = 'none'; this.value = 'Cadastrar audiência'; }" />
</div><div><div class="spoiler" style="display: none;"> <!-- Não pode mudar essa identação -->

<h3>Cadastrar audi&ecirc;ncia</h3>
<form method="post" action="<?php echo base_url();?>cacaocivel/createaudienciacivel" name="formaudiencia" onsubmit="return validaudiencia()">
<input type="hidden" name="idacao" id="idacao" size="16"  value="<?php echo $IdAcao;?>"/>
<input type="hidden" name="tipoacao" id="tipoacao" size="16"  value="<?php echo $AcaoTipoId;?>"/>
...
<div class="row">
	<div class="label">Audi&ecirc;ncia hora</div>
	<div class="field">
...
<div class="row">
	<div class="label">Audi&ecirc;ncia tipo</div>
	<div class="field">
...
<hr>
<input type="submit" value="Gravar audi&ecirc;ncia" class="botao"/>
</form>
</fieldset>
<?php } ?>
				...
				<td width=20% class="middle" style="text-align:left; text-transform:uppercase;">
					<?php foreach ($tipoaudiencia as $tpaud):
						if($AudienciaTipo == $tpaud->Id){
							echo $tpaud->Descricao;
						}
						endforeach;
					?>
				</td>
				<td width=30% class="middle" style="text-align:left; text-transform:uppercase;"><?php echo $AudienciaPreposto;?></td>
				<td width=25% class="middle" style="text-align:left; text-transform:uppercase;"><?php echo $Observacao;?></td>
				<?php if(($_SESSION['Admin']==1)||($_SESSION['Nivel1']==1)){ //1 JURÍDICO - ADMINISTRADOR ?>
				<td class="middle" width=5%>
					<a href="<?php echo base_url(); ?>cacaocivel/editaudienciacivel/<?php echo $AcaoId;?>/<?php echo $IdRegAud;?>" title="Alterar este registro.">
						<img src="<?php echo base_url();?>img/icons/pencil.png" alt="editar"/>
					</a>
				</td>
				<td class="middle" width=5%>
					<a href="#"	onclick='return excluiaudiencia(<?php echo $AcaoId;?>,<?php echo $IdRegAud;?>,<?php echo $AcaoTipoId;?>);' title="Deletar este registro.">
...
<form method="post" action="<?php echo base_url();?>cacaocivel/createandamentocivel" name="formandamento" onsubmit="return validandamento()">
<input type="hidden" name="idacao" id="idacao" size="16"  value="<?php echo $IdAcao;?>"/>
<input type="hidden" name="tipoacao" id="tipoacao" size="16"  value="<?php echo $AcaoTipoId;?>"/>
	...
	<table class="data_grid" cellspacing="0">
		...
		foreach($andamentos as $and):
			...
			<tr style="border:0;">
				...
				<?php } endforeach;?>
				<td width=35% class="middle" style="text-align:left; text-transform:uppercase;"><?php echo utf8_encode($ObsAndamento)?></td>
				<?php if(($_SESSION['Admin']==1)||($_SESSION['Nivel1']==1)){ //1 JURÍDICO - ADMINISTRADOR ?>
				<td class="middle" width=5%>
					<a href="<?php echo base_url(); ?>cacaocivel/editandamentocivel/<?php echo $AcaoId;?>/<?php echo $IdRegAnd;?>/<?php echo $AcaoTipoId;?>" title="Alterar este registro.">
						<img src="<?php echo base_url();?>img/icons/pencil.png" alt="editar" />
					</a>
				</td>
				<td class="middle" width=5%>
					<a href="#"	onclick='return excluiandamento(<?php echo $AcaoId;?>,<?php echo $IdRegAnd;?>,<?php echo $AcaoTipoId;?>);' title="Deletar este registro.">
						<img src="<?php echo base_url();?>img/icons/delete.png" alt="apagar" />
					</a>
				</td>
				<?php }else{ ?>
...
<form method="post" action="<?php echo base_url();?>cacaocivel/createprazocivel" name="formprazo" onsubmit="return validaprazo()">
<input type="hidden" name="idacao" id="idacao" size="16"  value="<?php echo $IdAcao;?>"/>
<input type="hidden" name="tipoacao" id="tipoacao" size="16"  value="<?php echo $AcaoTipoId;?>"/>
...
<div class="row">
	...
	<div class="field">
		<label> <input type="checkbox" name="prazoconcluido[]" value="1" id="prazoconcluido" />Conclu&iacute;do</label>
	</div>
</div>
			...
			<tr style="border:0;">
				...
				if($Concluido==1){ $status = 'checked_checkbox.png'; };
					if(($_SESSION['Admin']==1)||($_SESSION['Nivel1']==1)){ //1 JURÍDICO - ADMINISTRADOR ?>
						...
						<td class="middle" width=5%>
							<a href="<?php echo base_url(); ?>cacaocivel/editprazocivel/<?php echo $AcaoId;?>/<?php echo $IdPrazo;?>" title="Alterar este registro.">
								<img src="<?php echo base_url();?>img/icons/pencil.png" alt="editar" />
							</a>
						</td>
						<td class="middle" width=5%>
							<a href="#"	onclick='return excluiprazo(<?php echo $AcaoId;?>,<?php echo $IdPrazo;?>,<?php echo $AcaoTipoId;?>);' title="Deletar este registro.">
								<img src="<?php echo base_url();?>img/icons/delete.png" alt="apagar" />
							</a>
						</td>
					<?php
...
<div class="row">
		<div class="field">
		<input type="text" name="causadata" id="causadata" value="DATA" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="causa" id="causa" value="CAUSA" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="causavalor" id="causavalor" value="<?php echo $CausaValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="sentencadata" id="sentencadata" value="DATA" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="sentenca" id="senteca" value="SENTENÇA" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="<?php echo $SentencaValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="DATA" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="ACÓRDÃO" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="<?php echo $AcordaoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
	...
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="CÁLCULO HOMOLOGADO" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="<?php echo $CalculoHomologadoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
<div class="row">
		<div class="field">
	...
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="VALOR FINAL PAGO" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="fundlegal" id="fundlegal" value="<?php echo $CondenacaoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" readonly/>
	</div>
</div>
</a>
<a href="<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="EDITAR" onclick="location.href('<?php echo base_url()."cacaocivel/editacaocivel/".$IdAcao;?>')" class="botao">
</a>
<!--<input type="submit" value="Salvar" class="botao" style="text-decoration:none;"/>&nbsp;
	<a href="<?php echo base_url()."cjuridico/index/";?>" style="text-decoration:none;"-->
		<!--<input type="button" value="Cancelar" onclick="location.href('<?php echo base_url()."cjuridico/index/";?>')" class="botao" ;>
	</a>-->
</a>
</div>
</fieldset>
