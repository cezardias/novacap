...
if($prazosresult!=NULL):
	...
	$titulo = array();
	$col = array();	 
	$col[] = array('text' => 'RELATÓRIO DE PRAZOS', 'width' => '275', 'height' => '10', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '20', 'font_style' => 'B', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'B');	
	$titulo[] = $col;
	...
	if($soma==0){$concluido='NÃO';}
	if($soma==1){$concluido='SIM';}
	if($soma=='NULL'){$concluido='TODOS';}

	$titulo = array();
	$col = array();	 
	$col[] = array('text' => 'PERÍODO:', 'width' => '35', 'height' => '5', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	...
	$titulo = array();
	$col = array();	 
	$col[] = array('text' => 'TIPO DE AÇÃO:', 'width' => '35', 'height' => '5', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	...
	$titulo = array();
	$col = array();	 
	$col[] = array('text' => 'CONCLUÍDO:', 'width' => '35', 'height' => '5', 'align' => 'L', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => '');
	...
	$col[] = array('text' => 'DESCRIÇÃO', 'width' => '65', 'height' => '5', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '235,235,235', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
	$col[] = array('text' => 'OBSERVAÇÃO', 'width' => '65', 'height' => '5', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '9', 'font_style' => 'B', 'fillcolor' => '235,235,235', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
	...
	foreach($prazosresult as $prz):
		...
		$col[] = array('text' => strtoupper($PrazoDescricao), 'width' => '65', 'height' => '5', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '8', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
		$col[] = array('text' => strtoupper($Observacoes), 'width' => '65', 'height' => '5', 'align' => 'C', 'font_name' => 'Arial', 'font_size' => '8', 'font_style' => '', 'fillcolor' => '255,255,255', 'textcolor' => '0,0,0', 'drawcolor' => '0,0,0', 'linewidth' => '0.1', 'linearea' => 'LRTB');
