...
<a href="<?php echo base_url()."cjuridico/relatauditoria/";?>" target="_blank"><input type="button" value=".PDF" onclick="location.href('<?php echo base_url()."cjuridico/relataudiencia/";?>')" class="botao" style="width: 150px;"></a>
<a href="<?php echo base_url()."cjuridico/relatauditoriaexcel/";?>" style="text-decoration:none;">
	<input type="button" value=".EXCEL" onclick="location.href('<?php echo base_url()."cjuridico/relatauditoriaexcel/";?>')" class="botao" style="width: 150px;">
</a>
