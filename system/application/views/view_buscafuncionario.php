...
<div class="row">
	<div class="well well-sm">
		<h3 style="margin-left:10px;">Pesquisar interessado</h3>
	</div>
</div>
<form onsubmit="document.location.href='<?php echo base_url();?>buscaservidor/searchCPFCNPJ/'+document.getElementById('cpfcnpj').value;return false;">
	<div class="row" style="width:690px;">
		...
		<div class="col-xs-4">
			<input type="text" class="form-control" name="cpfcnpj" id="cpfcnpj" value="" onkeypress='return SomenteNumero(event)' placeholder="Somente número..." autofocus>
		</div>
		<div class="col-xs-3">
...
<form onsubmit="document.location.href='<?php echo base_url();?>buscaservidor/search/'+document.getElementById('q').value;return false;">
	<div class="row" style="width:690px;">
		<div class="col-xs-2">
				...
				foreach($records as $item):
					...
					<tr>
						<td style="width:130px;font-size:14px;">
							<a href="" id="campoFilho" onclick="putData('<?php echo $item->Id?>','<?php echo $Nome?>')" text-decoration="overline"><?php echo $cpfcnpjmask?></a>
						</td>
...
<div class="alert alert-warning">
  <strong>Atenção!</strong>
  <br>Interessado não encontrado. Cadastrá-lo agora?&nbsp;
