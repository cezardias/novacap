...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'CONDENACAO');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'CALC. HOMOLOGADO');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'ACORDAO');
...
foreach ($resultvlc as $it):
	...
	//if($Interessado != "ZZZZZZZ"){
	    ...
	    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$linha, $Condenacao);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$linha, $CalculoHomologado);
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$linha, $Acordao);
