...
<div class="row">
		<div class="field">
		<input type="text" name="causadata" id="causadata" value="<?php echo $CausaData?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" />
	</div>
	<div class="field">
		<input type="text" name="causa" id="causa" value="CAUSA" size="70" style="text-transform: uppercase;background-color:#F2F2F2;" readonly/>
	</div>
	<div class="field">
		<input type="text" name="causavalor" id="causavalor" value="<?php echo $CausaValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" required/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="sentencadata" id="sentencadata" value="<?php echo $SentencaData?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" />
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="sentencavalor" id="sentencavalor" value="<?php echo $SentencaValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" required/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="acordaodata" id="acordaodata" value="<?php echo $AcordaoData?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" />
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="acordaovalor" id="acordaovalor" value="<?php echo $AcordaoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" required/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="calculohomologadodata" id="calculohomologadodata" value="<?php echo $CalculoHomologadoData?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" />
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="calculohomologadovalor" id="calculohomologadovalor" value="<?php echo $CalculoHomologadoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" required/>
	</div>
</div>
<div class="row">
		<div class="field">
		<input type="text" name="condenacaodata" id="condenacaodata" value="<?php echo $CondenacaoData?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" />
	</div>
	<div class="field">
	...
	<div class="field">
		<input type="text" name="condenavalor" id="condenavalor" value="<?php echo $CondenacaoValor?>" size="20" style="text-transform: uppercase;background-color:#FFFFFF;" onKeyPress="return MascaraMoeda(this,'.',',',event);" style="text-align:right;" required/>
	</div>
</div>
</a>
<!--<a href="<?php echo base_url()."cjuridico/editacaotrabcont/".$IdAcao;?>" style="text-decoration:none;">
	<input type="button" value="EDITAR" onclick="location.href('<?php echo base_url()."cjuridico/f/".$IdAcao;?>')" class="botao">
</a>-->
