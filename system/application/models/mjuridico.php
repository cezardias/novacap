...
class Mjuridico extends Model {
	...
	function getAcoesGerais($idAcao){
		$this->db->query('SET ANSI_NULLS ON');
	 	$this->db->query('SET ANSI_WARNINGS ON');
		$sql = "Select * from vw_Acoes where AcoesId=$idAcao";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function getAcoesQtd($interesado,$prjudnum,$pradmnum,$assuntoid,$advogadoid,$varaid,$obsbusca,$statusprocessoid,$andamentoid,$posicaonovacap,$cpfcnpj,$dtajuizamentoini,$dtajuizamentofim,$dtextincaoini,$dtextincaofim,$prsei,$dtinclusaoini,$dtinclusaofim){
		$this->db->query('SET ANSI_NULLS ON');
	 	$this->db->query('SET ANSI_WARNINGS ON');
		$sql = "exec dbo.PesquisaAcaoTrabalhista $interesado,$prjudnum,$pradmnum,$assuntoid,$advogadoid,$varaid,$obsbusca,$statusprocessoid,$andamentoid,$posicaonovacap,$cpfcnpj,$dtajuizamentoini,$dtajuizamentofim,$dtextincaoini,$dtextincaofim,$prsei,$dtinclusaoini,$dtinclusaofim,null,null,0";
		$query = $this->db->query($sql);
		return $query->result();
	}

	function getAcoesResult($interesado,$prjudnum,$pradmnum,$assuntoid,$advogadoid,$varaid,$obsbusca,$statusprocessoid,$andamentoid,$posicaonovacap,$cpfcnpj,$dtajuizamentoini,$dtajuizamentofim,$dtextincaoini,$dtextincaofim,$prsei,$dtinclusaoini,$dtinclusaofim,$perpage,$primeiroregistro){
		$this->db->query('SET ANSI_NULLS ON');
	 	$this->db->query('SET ANSI_WARNINGS ON');
		$porpagina = $perpage;
		...
		$sql = "exec dbo.PesquisaAcaoTrabalhista $interesado,$prjudnum,$pradmnum,$assuntoid,$advogadoid,$varaid,$obsbusca,$statusprocessoid,$andamentoid,$posicaonovacap,$cpfcnpj,$dtajuizamentoini,$dtajuizamentofim,$dtextincaoini,$dtextincaofim,$prsei,$dtinclusaoini,$dtinclusaofim,$porpagina,$primeiroregistro,1";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function getAcaoDetail($idAcao){
		$this->db->query('SET ANSI_NULLS ON');
	 	$this->db->query('SET ANSI_WARNINGS ON');
		$sql = "Select * from vw_Acoes where Id=$idAcao";
		$query = $this->db->query($sql);
		return $query->result();
	}
